module ProcessxmlStubs
  ...
  def stub_processxml_list_dimensions dimension_type: 'DEB', company: 'company', oauth: false
    twinfield_header = oauth ? "<Header xmlns=\"http://www.twinfield.com/\"><AccessToken>2b128baa05dd3cabc61e534435884961</AccessToken></Header>" : "<Header xmlns=\"http://www.twinfield.com/\"><SessionID>session_id</SessionID></Header>"

    stub_request(:post, "https://accounting.twinfield.com/webservices/processxml.asmx").
      with(
        body: "<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"http://www.twinfield.com/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Header>#{twinfield_header}</soap:Header><soap:Body><ProcessXmlString xmlns=\"http://www.twinfield.com/\"><xmlRequest><![CDATA[\n            <list>\n              <type>dimensions</type>\n              <dimtype>#{dimension_type}</dimtype>\n<office>#{company}</office>\n            </list>\n          ]]></xmlRequest></ProcessXmlString></soap:Body></soap:Envelope>",
         headers: {
